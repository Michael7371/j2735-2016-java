...
abstract public class Reg_SupplementalVehicleExtensions<TValue> extends RegionalExtension<TValue> {

	public Reg_SupplementalVehicleExtensions(int id, String name) {
		super(id, name);
	}
}
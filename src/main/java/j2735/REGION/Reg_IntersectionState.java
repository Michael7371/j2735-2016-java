...
@JsonSubTypes({
		@JsonSubTypes.Type(value = j2735.AddGrpC.IntersectionState_addGrpCReg_IntersectionState.class, name = "3")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = j2735.AddGrpC.IntersectionState_addGrpCReg_IntersectionState.class, intId = 3)})

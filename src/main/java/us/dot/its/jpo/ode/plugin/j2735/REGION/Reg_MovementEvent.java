...
import us.dot.its.jpo.ode.plugin.j2735.AddGrpB.MovementEvent_addGrpBReg_MovementEvent;
...
@JsonSubTypes({@JsonSubTypes.Type(value = MovementEvent_addGrpBReg_MovementEvent.class, name = "2")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = MovementEvent_addGrpBReg_MovementEvent.class, intId = 2)})

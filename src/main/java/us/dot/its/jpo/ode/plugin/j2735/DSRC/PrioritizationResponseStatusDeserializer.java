 ...
 * 
 */
public class PrioritizationResponseStatusDeserializer extends EnumeratedDeserializer<PrioritizationResponseStatus> {

	PrioritizationResponseStatusDeserializer() {

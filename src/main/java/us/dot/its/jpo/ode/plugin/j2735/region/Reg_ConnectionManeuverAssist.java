...
import us.dot.its.jpo.ode.plugin.j2735.addgrpc.ConnectionManeuverAssist_addGrpCReg_ConnectionManeuverAssist;

@JsonInclude(Include.NON_NULL)
@JsonTypeInfo(use = Id.NAME, include = As.EXISTING_PROPERTY, property = "regionId")
@JsonSubTypes({
		@JsonSubTypes.Type(value = ConnectionManeuverAssist_addGrpCReg_ConnectionManeuverAssist.class, name = "3")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = ConnectionManeuverAssist_addGrpCReg_ConnectionManeuverAssist.class, intId = 3)})

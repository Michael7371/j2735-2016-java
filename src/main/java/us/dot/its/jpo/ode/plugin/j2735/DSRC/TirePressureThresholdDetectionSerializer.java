 ...
 * 
 */
public class TirePressureThresholdDetectionSerializer extends EnumeratedSerializer<TirePressureThresholdDetection> {

	TirePressureThresholdDetectionSerializer() {

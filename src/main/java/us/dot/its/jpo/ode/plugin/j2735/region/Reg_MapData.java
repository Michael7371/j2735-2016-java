...
import us.dot.its.jpo.ode.plugin.j2735.addgrpc.MapData_addGrpCReg_MapData;

@JsonInclude(Include.NON_NULL)
@JsonTypeInfo(use = Id.NAME, include = As.EXISTING_PROPERTY, property = "regionId")
@JsonSubTypes({@JsonSubTypes.Type(value = MapData_addGrpCReg_MapData.class, name = "3")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = MapData_addGrpCReg_MapData.class, intId = 3)})

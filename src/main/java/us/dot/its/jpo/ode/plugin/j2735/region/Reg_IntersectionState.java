...
import us.dot.its.jpo.ode.plugin.j2735.addgrpc.IntersectionState_addGrpCReg_IntersectionState;

@JsonInclude(Include.NON_NULL)
@JsonTypeInfo(use = Id.NAME, include = As.EXISTING_PROPERTY, property = "regionId")
@JsonSubTypes({
		@JsonSubTypes.Type(value = IntersectionState_addGrpCReg_IntersectionState.class, name = "3")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = IntersectionState_addGrpCReg_IntersectionState.class, intId = 3)})

...
public class TravelerDataFrame extends Asn1Sequence {
	...
	@Asn1Property(tag = 0, name = "sspTimRights")
	@JsonProperty("sspTimRights")
	...
	@Asn1Property(tag = 5, name = "duratonTime")
	@JsonProperty("duratonTime")
	private MinutesDuration duratonTime;
	@Asn1Property(tag = 6, name = "priority")
	@JsonProperty("priority")
	private SignPrority priority;
	@Asn1Property(tag = 7, name = "sspLocationRights")
	@JsonProperty("sspLocationRights")
	private SSPindex sspLocationRights;
	@Asn1Property(tag = 8, name = "regions")
	@JsonProperty("regions")
	private SequenceOfRegions regions;
	@Asn1Property(tag = 9, name = "sspMsgRights1")
	@JsonProperty("sspMsgRights1")
	private SSPindex sspMsgRights1;
	@Asn1Property(tag = 10, name = "sspMsgRights2")
	@JsonProperty("sspMsgRights2")

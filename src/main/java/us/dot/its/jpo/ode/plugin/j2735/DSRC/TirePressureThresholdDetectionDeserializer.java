 ...
 * 
 */
public class TirePressureThresholdDetectionDeserializer extends EnumeratedDeserializer<TirePressureThresholdDetection> {

	TirePressureThresholdDetectionDeserializer() {

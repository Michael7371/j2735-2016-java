...
import us.dot.its.jpo.ode.plugin.j2735.addgrpc.RestrictionUserType_addGrpCReg_RestrictionUserType;

@JsonInclude(Include.NON_NULL)
@JsonTypeInfo(use = Id.NAME, include = As.EXISTING_PROPERTY, property = "regionId")
@JsonSubTypes({
		@JsonSubTypes.Type(value = RestrictionUserType_addGrpCReg_RestrictionUserType.class, name = "3")})
@Asn1ParameterizedTypes(idProperty = "regionId", idType = IdType.INTEGER, valueProperty = "regExtValue", value = {
		@Asn1ParameterizedTypes.Type(value = RestrictionUserType_addGrpCReg_RestrictionUserType.class, intId = 3)})
